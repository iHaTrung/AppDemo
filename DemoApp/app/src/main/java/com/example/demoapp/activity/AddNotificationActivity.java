...
public class AddNotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAddNotificationBinding.inflate(getLayoutInflater());
        ...
        binding.textTimeStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dpd = new DatePickerDialog(AddNotificationActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        String date = year + "/" + (month + 1) + "/" + dayOfMonth;
                        //binding.textTimeStart.setText(dayOfMonth + "/" + (month + 1) + "/" + year);
                        TimePickerDialog timePickerDialog = new TimePickerDialog(AddNotificationActivity.this,
        ...
        call.enqueue(new Callback<ScheduleAddingResponse>() {
            ...
            public void onResponse(Call<ScheduleAddingResponse> call, Response<ScheduleAddingResponse> response) {
                ...
                if (scheduleAddingResponse.getCode() == 200) {
                    Toast.makeText(AddNotificationActivity.this, scheduleAddingResponse.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<ScheduleAddingResponse> call, Throwable t) {
                Toast.makeText(AddNotificationActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
