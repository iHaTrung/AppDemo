...
import com.example.demoapp.databinding.ActivityCommunicationsBinding;
...
public class CommunicationsActivity extends AppCompatActivity {
    ...
    ActivityCommunicationsBinding binding;
    Calendar c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCommunicationsBinding.inflate(getLayoutInflater());
        ...
        binding.textTimeStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dpd = new DatePickerDialog(CommunicationsActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        String date = year + "/" + (month + 1) + "/" + dayOfMonth;
                        //binding.textTimeStart.setText(dayOfMonth + "/" + (month + 1) + "/" + year);
                        TimePickerDialog timePickerDialog = new TimePickerDialog(CommunicationsActivity.this,
        ...
        call.enqueue(new Callback<ScheduleAddingResponse>() {
            ...
            public void onResponse(Call<ScheduleAddingResponse> call, Response<ScheduleAddingResponse> response) {
                ...
                if (scheduleAddingResponse.getCode() == 200) {
                    Toast.makeText(CommunicationsActivity.this, scheduleAddingResponse.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<ScheduleAddingResponse> call, Throwable t) {
                Toast.makeText(CommunicationsActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
